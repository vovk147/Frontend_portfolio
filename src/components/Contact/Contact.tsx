  ...
  return (
    <section className="contact-glass" id="contact">
      ...
      <div className="container">
        <motion.div 
          className="contact-glass__header"
        ...
        <div className="contact-grid">
          {/* ИНФО БЛОК */}
          <motion.div 
            className="contact-info-card split-bg-card"
            ...
            <div className="info-specs">
              ...
              <div className="spec-item">
                ...
                <div className="spec-text">
                  ...
                  <span className="value">vovk.zheka1@outlook.com</span>
                </div>
              </div>
              <div className="spec-item">
                <Phone className="spec-icon" />
                <div className="spec-text">
                  <span className="label">SECURE LINES (PL / UKR)</span>
                  <span className="value">+48 739 500 702</span>
                  <span className="value">+380 99 313 3600</span>
                </div>
              </div>
              <div className="spec-item">
                ...
                <div className="spec-text">
                  ...
                  <span className="value text-green">{t('contact.status_val')}</span>
                </div>
              </div>
            </div>
          ...
          {/* ФОРМА (ТОЖЕ СО СПЛИТ-ФОНОМ) */}
          <motion.div 
            className="contact-form-card split-bg-card"
            ...
            <AnimatePresence mode="wait">
              {status === "success" ? (
                <motion.div 
                  ...
                  initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} transition={{ type: "spring", stiffness: 100 }}
                >
                ...
                <motion.form 
                  key="form"
                  onSubmit={handleSubmit} className="rs-form"
